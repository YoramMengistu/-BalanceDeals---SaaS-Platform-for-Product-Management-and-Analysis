...
import { ClerkIcon } from "./_components/icons/ClerkIcon";
import { NeonIcon } from "./_components/icons/NeonIcon";
import { subscriptionTiersInOrder } from "@/data/subscritionTiers";
    ...
    <>
      <section className="min-h-screen bg-[radial-gradient(hsl(0,72%,65%,40%),hsl(24,62%,73%,40%),hsl(var(--background))_60%)] flex items-center justify-center text-center text-balance flex-col gap-8 px-4">
        ...
        <p className="text-lg lg:text-3xl max-w-screen-xl">
          Adjust your pricing strategy globally to boost sales. Unlock 85% of //
          the hidden market with location-driven pricing.
        </p>
        <SignUpButton>
...
function PricingCard({
  ...
  return (
    ...
    >
      ...
      <CardHeader>
        <div className="text-accent font-semibold mb-8 text-blue-400">
          {name}
        </div>
      ...
      <CardContent>
        <SignUpButton>
          <Button
            ...
            variant={isMostPopular ? "secondary" : "default"}
          >
            Get Started
          </Button>
        </SignUpButton>
      ...
      <CardFooter className="flex flex-col gap-4 items-start">
        ...
        {canRemoveBranding && <Feature>Remove Deals branding</Feature>}
